...
ActiveRecord::Schema.define(version: 20160202183037) do
  ...
  add_index "packets", ["category_id"], name: "index_packets_on_category_id"
  add_index "packets", ["product_id"], name: "index_packets_on_product_id"
  add_index "packets", ["tag_id"], name: "index_packets_on_tag_id"
